...
if __name__ == '__main__':
    ...
    nll, _, ece, mce, macro_nll = eval_calibration(labels, ens_preds)
    print('nll:', nll)
    print('ece:', ece)
    print('mce:', mce)
    print('macro_nll:', macro_nll)
    print('---------------')
    print('---------------')
    ...
    print(f'macro_nll: {macro_nlls.mean()} +- {macro_nlls.std()}')
    print('---------------')
    print('---------------')