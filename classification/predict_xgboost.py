'''
Generate prediction files for xgboost models in the following format:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='xgboost predict.')
    ...
    if not os.path.isdir('CMDs'):
        os.mkdir('CMDs')
    with open('CMDs/predict_xgboost.cmd', 'a') as f:
    ...
    for seed in range(1, ensemble_size+1):
        ...
        model = pickle.load(f'{args.trained_models_dir}/seed{seed}.dat')
